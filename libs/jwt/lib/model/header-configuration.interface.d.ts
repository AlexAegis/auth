...
export declare const DEFAULT_HEADER_CONFIG: Partial<HeaderConfiguration>;
...
export interface HeaderConfiguration extends UrlFilter {
     ...
     */
    getValue: Observable<string | null | undefined> | (() => string | null | undefined | Promise<string | null | undefined> | Observable<string | null | undefined>);
    /**
