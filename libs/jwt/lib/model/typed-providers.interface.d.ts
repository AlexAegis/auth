 ...
 */
import { ClassSansProvider, ConstructorSansProvider, ExistingSansProvider, FactorySansProvider, InjectionToken, Type, ValueSansProvider } from '@angular/core';
...
export declare interface TypedFactoryProvider<T, A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any, I = any, J = any, K = any, L = any, M = any, N = any, O = any, P = any, Q = any, R = any, S = any, U = any, V = any, W = any, X = any, Y = any, Z = any> extends TypedFactorySansProvider<T, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R, S, U, V, W, X, Y, Z> {
    provide: Type<T | T[]>;
    multi?: boolean;
}
export declare interface TypedFactorySansProvider<T, A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any, I = any, J = any, K = any, L = any, M = any, N = any, O = any, P = any, Q = any, R = any, S = any, U = any, V = any, W = any, X = any, Y = any, Z = any> extends FactorySansProvider {
    useFactory: (a: A, b: B, c: C, d: D, e: E, f: F, g: G, h: H, i: I, j: J, k: K, l: L, m: M, n: N, o: O, p: P, q: Q, r: R, s: S, u: U, v: V, w: W, x: X, y: Y, z: Z) => T;
    deps?: [
        Type<A>?,
        Type<B>?,
        Type<C>?,
...
export declare type TypedProvider<T extends Record<string, any> | Type<any> | InjectionToken<any> = Record<string, any>, A = any, B = any, C = any, D = any, E = any, F = any, G = any, H = any, I = any, J = any, K = any, L = any, M = any, N = any, O = any, P = any, Q = any, R = any, S = any, U = any, V = any, W = any, X = any, Y = any, Z = any> = TypedClassProvider<T> & TypedValueProvider<T> & TypedExistingProvider<T> & TypedFactoryProvider<T, A, B, C, D, E, F, G, H, I, J, K, L, M, N, O, P, Q, R, S, U, V, W, X, Y, Z>;
